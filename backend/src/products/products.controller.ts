...
export class ProductsController {
    ...
    @ApiQuery({ name: 'name', required: false, type: String, description: 'Filtro por nome do produto' })
    ...
    @ApiQuery({ name: 'category', required: false, type: String, description: 'Categoria do produto' })
    @ApiQuery({ name: 'color', required: false, type: String, description: 'Cor do produto' })
